(function () {
    ...
    var MD_CSS = [
        ...
        "background:radial-gradient(circle,rgba(201,169,110,.07) 0%,transparent 48%);",
        "animation:jf-md-beam-pulse 7s ease-in-out infinite;}",
        ...
        ".jf-md-logo{width:56px;height:56px;margin:0 auto 22px;display:block;color:#E4C88B;",
        "filter:drop-shadow(0 0 14px rgba(201,169,110,.45));",
        "animation:jf-md-breathe 5s ease-in-out infinite,jf-md-reel-spin 60s linear infinite;}",
